            ...
            <div className="container border rounded marketing">
                ...
                <div className="row">
                    ...
                    <div className="col-lg-4">
                        <svg xmlns="http://www.w3.org/2000/svg" width="120" height="120" fill="currentColor" class="bi bi-geo-alt-fill mb-3 rounded-circle p-3 geo" viewBox="0 0 16 16">
                    ...
                    <div className="col-lg-4">
                        <svg xmlns="http://www.w3.org/2000/svg" width="120" height="120" fill="currentColor" class="bi bi-car-front-fill mb-3 rounded-circle p-3 mobile" viewBox="0 0 16 16">
                    ...
                    <div className="col-lg-4">
                        <svg xmlns="http://www.w3.org/2000/svg" width="120" height="120" fill="currentColor" class="bi bi-shop rounded-circle mb-3 shop" viewBox="0 -2 16 23">
